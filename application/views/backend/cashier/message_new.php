...
<div class="mail-compose">
    ...
    <?php echo form_open(base_url() . 'index.php?cashier/message/send_new/', array('class' => 'form', 'enctype' => 'multipart/form-data')); ?>
    ...
    <div class="form-group">
        ...
        <select class="form-control select2" name="reciever" required>
            ...
            <optgroup label="<?php echo get_phrase('Maintenance'); ?>">
                <?php
                $maintenance= $this->db->get('maintenance')->result_array();
            ...
            <optgroup label="<?php echo get_phrase('Manager'); ?>">
                <?php
                $manager = $this->db->get('manager')->result_array();
                foreach ($manager as $row):
                    ?>

                    <option value="manager-<?php echo $row['id']; ?>">
                        - <?php echo $row['firstname'].' '.$row['lastname']; ?></option>

...
<!--                <img src="--><?php //echo $this->crud_model->get_image_url($sender_account_type, $sender_id); ?><!--" class="img-circle" width="30"> -->
                <span><?php echo $this->db->get_where($sender_account_type, array('id' => $sender_id))->row()->firstname; ?></span>
            </a>
        </div>
...
<?php echo form_open(base_url() . 'index.php?maintenance/message/send_reply/' . $current_message_thread_code, array('enctype' => 'multipart/form-data')); ?>

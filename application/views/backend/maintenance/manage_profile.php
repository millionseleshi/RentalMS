            ...
            <div class="tab-pane box active" id="list" style="padding: 5px">
                <div class="box-content">
                    ...
                    foreach ($edit_data as $row):
                        ?>
                        <?php echo form_open(base_url() . 'index.php?maintenance/manage_profile/update_profile_info', array('class' => 'form-horizontal form-groups-bordered validate', 'target' => '_top', 'enctype' => 'multipart/form-data')); ?>
                                    ...
                                    <div class="fileinput-new thumbnail"
                                        ...
                                        <?php if($row['profile_image']==null):?>
                                            <img src="<?php echo base_url().'assets/images/admin.png'; ?>" class="img-rounded"
                                                 ...
                                                 alt="...">
                                        <?php else:?>
                                            <img src="<?php echo base_url().'uploads/MaintenanceImage/'.$row['profile_image']; ?>" class="img-rounded"
                                                 height="200px" width="200px"
                                                 alt="...">
                                        <?php endif;?>
                                    </div>
        ...
        <div class="tab-content">
            ...
            <div class="tab-pane box active" id="list" style="padding: 5px">
                <div class="box-content padded">
                    ...
                    foreach ($edit_data as $row):
                        ?>
                        <?php echo form_open(base_url() . 'index.php?maintenance/manage_profile/change_password',
